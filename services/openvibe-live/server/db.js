...
function init(dbPath) {
    persistenceDescriptor = warnIfUnsupported('openvibe-live', dbPath);
...
function describePersistence() {
    return persistenceDescriptor || { service: 'openvibe-live', mode: 'sqlite', database_url_configured: false };
}
