...
async function validateBundle(options) {
    ...
    const userRefChecks = [
        ...
        { file: path.join(bundleDir, 'games', 'players.ndjson'), fields: ['user_id'] },
        { file: path.join(bundleDir, 'games', 'inventory.ndjson'), fields: ['user_id'] },
        { file: path.join(bundleDir, 'games', 'bank.ndjson'), fields: ['user_id'] },
        { file: path.join(bundleDir, 'games', 'structures.ndjson'), fields: ['owner_user_id'] },
        { file: path.join(bundleDir, 'games', 'farm-plots.ndjson'), fields: ['user_id'] },
        { file: path.join(bundleDir, 'games', 'recipes.ndjson'), fields: ['user_id'] },
        { file: path.join(bundleDir, 'games', 'effects.ndjson'), fields: ['user_id'] },
        { file: path.join(bundleDir, 'games', 'battle-stats.ndjson'), fields: ['user_id'] },
        { file: path.join(bundleDir, 'games', 'dungeon-runs.ndjson'), fields: ['user_id'] },
        { file: path.join(bundleDir, 'games', 'leaderboards.ndjson'), fields: ['user_id'] },
        { file: path.join(bundleDir, 'games', 'fish-collection.ndjson'), fields: ['user_id'] },
        { file: path.join(bundleDir, 'games', 'daily-quests.ndjson'), fields: ['user_id'] },
        { file: path.join(bundleDir, 'games', 'achievements.ndjson'), fields: ['user_id'] },
        { file: path.join(bundleDir, 'games', 'cosmetics.ndjson'), fields: ['user_id'] },
        { file: path.join(bundleDir, 'games', 'tags.ndjson'), fields: ['user_id'] },
        { file: path.join(bundleDir, 'games', 'equipped-tags.ndjson'), fields: ['user_id'] },
        { file: path.join(bundleDir, 'games', 'tag-guardian-defeats.ndjson'), fields: ['user_id'] },
        { file: path.join(bundleDir, 'games', 'canvas-tiles.ndjson'), fields: ['user_id'] },
        { file: path.join(bundleDir, 'games', 'canvas-actions.ndjson'), fields: ['user_id'] },
        { file: path.join(bundleDir, 'games', 'canvas-snapshots.ndjson'), fields: ['created_by_user_id'] },
        { file: path.join(bundleDir, 'games', 'canvas-region-locks.ndjson'), fields: ['created_by_user_id'] },
        { file: path.join(bundleDir, 'games', 'canvas-bans.ndjson'), fields: ['user_id', 'created_by_user_id'] },
        { file: path.join(bundleDir, 'games', 'canvas-user-overrides.ndjson'), fields: ['user_id', 'updated_by_user_id'] },
    ];
